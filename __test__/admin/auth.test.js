...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Edwardo_Kuphal38',
      password: 'JqutNOcHlZRHi6i',
      email: 'Courtney.Rosenbaum@yahoo.com',
      name: 'Jasmine Ortiz',
      userType: 981,
      mobileNo: '(791) 272-6314',
      resetPasswordLink: {},
      loginRetryLimit: 738,
      loginReactiveTime: '2023-10-16T10:15:10.627Z',
      id: '63511a415063892e8bc5f7ee'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Granville21',
        'password':'dC7my0iEsIRdEjF',
        'email':'Taurean.Hettinger@hotmail.com',
        'name':'Carolyn Gleason',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(458) 860-5559',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Taurean.Hettinger@hotmail.com', });
